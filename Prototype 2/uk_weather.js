...
(function(){
    ...
    var Map = function(datafile, parent, title, channel, cb, width, height, scale) {
        ...
        // this.projection = d3.geo.albers()    /// Black thing
        //     .center([0, 55.4])
        //     .rotate([4.4, 0])
        //     .parallels([50, 60])
        //     .scale(this.scale)
        ...
        d3.json("uk.json", function(error, uk) { //Data
    ...
    Map.prototype = {
        initGrid: function() {
            var map = this;
            d3.json('gridpoints.json', function(error, json) {
                console.log(error);
                ...
                d3.csv(map.datafile, function(error, data) {
                    ...
                    map.data = data;
                    data.forEach(function(d) {        ////////////IMPORT
        ...
        scaleData: function() {
            ...
            // this.colorbar.append('rect')             //////////SCALEBAR
            ...
            // this.colorbar.append('text')          //////SCALEBAR TEXT
            //     .text(function(d, i) {
    ...
    var maps = [];
    maps.push(new Map('station_data_sun.csv', '#vizsun', 'Hours of sunshine per month', 'maps', setTitles)); 
    // maps.push(new Map('station_data_rain.csv', '#vizrain', 'Milimetres of rain per month', 'maps')); 
    // maps.push(new Map('station_data_tmax.csv', '#viztmax', 'Maximum temp (deg. celcius)', 'maps')); 
    var num_map_uninit = 1;
